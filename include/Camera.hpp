...
enum class CameraMode { CHASE, HOOD, FREE };
...
public:
  ...
  void updateChase(const glm::vec3 &carPosition, const glm::vec3 &carForward,
                   float deltaTime);
  void updateHood(const glm::vec3 &carPosition, const glm::vec3 &carForward,
                  const glm::vec3 &carUp);
